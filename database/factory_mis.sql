...
INSERT INTO `stack_to_market_lists` (`id`, `item_name`, `item_type`, `fixed_price`, `sell_price`, `quantity`, `remaining`) VALUES
(1, 'فوم بلاک 2x1', 'دانه ', 0, 1, 4, 0),
(2, 'کاک 70*2', 'دانه', 0, 3, 70, 0),
(3, 'کاک 70*2 تراکم 10', 'دانه', 0, 5, 17, 0);
